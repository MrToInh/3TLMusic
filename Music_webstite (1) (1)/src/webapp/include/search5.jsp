...
<%@ page import="music.business.Song"%>
			...
			<div class="div--hun">
				<form class="form--hun" action="SearchServlet" method="get">
					<input
						...
						data-testid="search-input" value="" style="color: rgb(0, 0, 0);" name="searchTerm">
					<button type="submit" style="background-color: #042058; color: #f17822; padding: 8px 90px; border: none; border-radius: 29px; cursor: pointer; text-align: center;">Search</button>
